#ifndef CYCAMORE_SRC_BULK_REACTOR_H_
#define CYCAMORE_SRC_BULK_REACTOR_H_
...
class BulkReactor : public cyclus::Facility,
...
"doc": \
 ...
 public:
  BulkReactor(cyclus::Context* ctx);
  virtual ~BulkReactor(){};
 ...
 private:
  ...
  bool Discharge_Transmute(double qty);
  bool Discharge_Transmute(double qty, double transmute_qty);
 ...
 //////////// inventory and core params ////////////
  ...
  #pragma cyclus var { \
    "default": 0, \
    "uilabel": "Maximum fresh fuel inventory", \
    "uitype": "range", \
    "range": [0,3], \
    "units": "kg", \
    "doc": "Maximum fresh fuel inventory", \
  }
  double fresh_mass;
  #pragma cyclus var { \
    "uilabel": "Amount of fuel discharged per cycle length.", \
    "uitype": "range", \
    "range": [0,3], \
    "units": "kg", \
    "doc": "Amount of fuel discharged per cycle length.", \
  }
  double discharge_mass;
  #pragma cyclus var { \
    "default": 1000000000, \
    ...
    "range": [0, 1000000000], \
    "units": "kg", \
    "doc": "Amount of fuel that can be stored in spent buffer", \
  }
  double spent_mass;
   ///////// cycle params ///////////
  #pragma cyclus var { \
  ...
  #pragma cyclus var {"capacity": "fresh_mass"}
  cyclus::toolkit::ResBuf<cyclus::Material> fresh;
  #pragma cyclus var {"capacity": "core_mass"}
  cyclus::toolkit::ResBuf<cyclus::Material> core;
  #pragma cyclus var {"capacity": "spent_mass"}
